  ...
  App.messages = App.cable.subscriptions.create({
        ...
        received: function(data) {
          ...
          if (window.location.href.match(/chats/)){
            ...
            this.renderMessageElseWhere(data);
          }
        },
        renderMessageOnChat: function(data) {
          ...
          document.getElementById('messages').insertAdjacentHTML("beforeend", '<div class="' + user_status + '-user-custom-row animated fadeIn delay-6"><a href="/users/' + data.user_id + '"><img class="avatar" src="' + data.user_avatar + '"></a><p class="' + user_status + '-user-message">' + data.message + '</p><p class="time-indicator-message">just now</p></div>');
        },

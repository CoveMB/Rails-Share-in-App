function createMessageChannel() {
  App.messages = App.cable.subscriptions.create({
    ...
    return '<div class="' + user_status + '-user-custom-row animated fadeIn delay-6"><a href="/users/' + data.user_id + '"><img class="avatar" src="' + data.user_avatar + '"></a><p class="' + user_status + '-user-message">' + data.message + '</p><p class="time-indicator-message">just now</p></div>';
  },
      });
return App.messages;
}
